...
import edu.infosysLostFoundLocatorApplication.bean.LostfoundUser;
import edu.infosysLostFoundLocatorApplication.config.EncoderConfig;
...
public class LoginController {
	@Autowired
	private edu.infosysLostFoundLocatorApplication.service.LostfoundUserService service;
